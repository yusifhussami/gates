...
**Tried:** wanted to add one small thing this session. First step, per usual, was to check git log and run the tests before touching anything.

**Broke:** every git/ls/cat call against the repo just hung and then errored out:
